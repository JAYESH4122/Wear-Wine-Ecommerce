...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
      ...
      >
        <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 shadow-sm border border-neutral-100 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
          
          <h1 className="text-2xl font-bold tracking-tight mb-2 relative z-10">Personal Information</h1>
          <p className="text-neutral-500 text-sm mb-8 relative z-10">Manage your personal details and how we can reach you.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-3 bg-neutral-50 border border-neutral-100 rounded-xl p-4">
                ...
                <span className="text-sm font-semibold text-neutral-900">{user.name || 'Not provided'}</span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-3 bg-neutral-50 border border-neutral-100 rounded-xl p-4">
                ...
                {user.isVerified && (
                  <span className="ml-auto text-[10px] bg-green-100 text-green-700 font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">Verified</span>
                )}
              </div>
            </div>
        ...
        <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 shadow-sm border border-neutral-100">
          <h2 className="text-lg font-bold tracking-tight mb-2">Account Preferences</h2>
          <p className="text-neutral-500 text-sm mb-6">Manage your email formatting and newsletter subscriptions.</p>
          ...
          <div className="flex items-center justify-between p-4 border border-neutral-100 rounded-xl bg-neutral-50">
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-0.5">Receive updates about new drops and exclusive offers.</p>
            </div>
